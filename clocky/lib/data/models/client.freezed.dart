...
class _$ClientImpl extends _Client {
  ...
  @override
  String toString() {
    return 'Client(id: $id, name: $name, email: $email, hourlyRate: $hourlyRate, notes: $notes, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, hourlyRate, notes, createdAt);
